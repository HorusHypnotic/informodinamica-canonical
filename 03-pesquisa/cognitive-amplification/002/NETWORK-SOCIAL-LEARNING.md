# NETWORK-SOCIAL-LEARNING.md

Network position and collaboration can change access to information, but access, assimilation and transfer are distinct. Network size may supply more contacts; diversity/brokerage may supply nonredundant information; closure may support trust and coordination. Negative effects include overload, redundancy, maintenance cost and groupthink.

| Candidate data | Baseline | Exposure | Later outcome | Transfer/retention | Main confounders |
|---|---|---|---|---|---|
| GitHub/GH Archive | prior developer/repo activity | collaboration, review, issues | later PR/issue/release proxies | possible novel task and retention windows | selection, skill, project difficulty |
| OULAD | prior assessment/VLE history | peer/platform activity | later score | course-long retention, no novel task | student ability, course, attrition |
| PLOS e0204547 | prior/context team features | collaboration network | later task score | absent | team composition, task difficulty |
| science-of-science graphs | prior career/output | interdisciplinary ties | later novelty/citations | long-term output, capability indirect | resources, selection, field, team |

A defensible analysis must compare HISTORY ONLY against HISTORY + NETWORK and define a genuinely future outcome. Commit count is not capability.

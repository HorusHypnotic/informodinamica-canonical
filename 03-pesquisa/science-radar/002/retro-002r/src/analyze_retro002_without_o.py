...
ROOT=Path('/home/ubuntu/retro002r'); OUT=ROOT/'retro002_outputs_without_o'; OUT.mkdir(exist_ok=True)
...
base_num=['impact_num','urgency_num','priority_num']; cat=['category_clean','contact_type','group']
...
r[['number','group','opened_at_dt','next_dt_hours','impact_num','urgency_num','X_backlog_30d','C_throughput_30d','C_capacity_proxy','C_prior_mean_resolution','H_prior_open_30d','H_prior_open_90d','H_prior_mean_duration_90d','next_Y_hours','delta_lt_24']].to_csv(OUT/'analysis_rows_retro002.csv',index=False)
